...
<body>
  ...
  <main id="main">
    ...
    <input type="text" name="studname" class="form-control" id="studname"  placeholder="Enter your full name here">
            </div>
            <div class="form-group">
                <label>How many tickets would you like to buy</label>
    <input type="number" name="studtic" class="form-control" id="studtic"  placeholder="Enter how many tikets would you like to but" >
            </div>
           
            <div class="form-check form-check" >
                <label>Select Year</label>
                <br>
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="first" required>
                <label class="form-check-label" for="inlineRadio1">1st Year</label>
              </div>
              <div class="form-check form-check">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="second"required >
                <label class="form-check-label" for="inlineRadio2">2nd Year</label>
              </div>
              <div class="form-check form-check">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="third"required>
                <label class="form-check-label" for="inlineRadio1">3rd Year</label>
              </div>
              <div class="form-check form-check">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="fourth"required>
                <label class="form-check-label" for="inlineRadio2">4th Year</label>
              </div>
            <div class="formBox">
                <button class="btn btn-primary" id="submitbtn" onclick="displayValue()">Buy and Procced</button>
